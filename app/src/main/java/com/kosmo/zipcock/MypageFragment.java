...
public class MypageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button button = (Button) rootView.findViewById(R.id.joinhelper);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getActivity().getApplicationContext(), InfoUpdate.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i(TAG,status);
                if(status.equals("2")) {
                    Intent intent = new Intent(getActivity().getApplicationContext(), HelperMain.class);
                    startActivity(intent);
                }
                else{
                    Toast.makeText(getActivity().getApplicationContext(), "헬퍼가 아닙니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
